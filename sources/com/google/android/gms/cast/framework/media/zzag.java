...
public final class zzag extends RemoteMediaClient.zzb {
    ...
    public final void zzb(zzaze zzaze) {
        synchronized (this.zzeud.mLock) {
            try {
                this.zzeud.zzemk.zzc(this.zzenr, this.zzemx);
            } catch (zzbaa | IOException unused) {
                setResult((zzag) ((RemoteMediaClient.MediaChannelResult) zzb(new Status(2100))));
            }
        }
        return;
    }
