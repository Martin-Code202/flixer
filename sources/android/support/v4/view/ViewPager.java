...
public class ViewPager extends ViewGroup {
    ...
    public void smoothScrollTo(int i, int i2, int i3) {
        ...
        if (abs > 0) {
            ...
            i5 = (int) ((1.0f + (((float) Math.abs(i6)) / (((float) this.mPageMargin) + (((float) clientWidth) * this.mAdapter.getPageWidth(this.mCurItem))))) * 100.0f);
        }
    ...
    public void populate(int i) {
        ...
        if (this.mAdapter == null) {
            ...
            if (itemInfo2 != null) {
                ...
                for (int i5 = this.mCurItem - 1; i5 >= 0; i5--) {
                    if (f3 < f || i5 >= max) {
                        if (itemInfo4 == null || i5 != itemInfo4.position) {
                            f3 += addNewItem(i5, i4 + 1).widthFactor;
                            i3++;
                            itemInfo4 = i4 >= 0 ? this.mItems.get(i4) : null;
                        } else {
                ...
                int i6 = i3 + 1;
                if (f4 < 2.0f) {
                    ItemInfo itemInfo5 = i6 < this.mItems.size() ? this.mItems.get(i6) : null;
                    if (clientWidth <= 0) {
                        f2 = 0.0f;
                    } else {
                    ...
                    for (int i7 = this.mCurItem + 1; i7 < count; i7++) {
                        if (f4 < f2 || i7 <= min) {
                            if (itemInfo5 == null || i7 != itemInfo5.position) {
                                ItemInfo addNewItem = addNewItem(i7, i6);
                                i6++;
                                f4 += addNewItem.widthFactor;
                                itemInfo5 = i6 < this.mItems.size() ? this.mItems.get(i6) : null;
                            } else {
        ...
        for (int i15 = 0; i15 < childCount; i15++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isDecor && (infoForChild = infoForChild(childAt2)) != null) {
                    int i16 = paddingLeft + ((int) (((float) i14) * infoForChild.offset));
                    if (layoutParams2.needsMeasure) {
                        layoutParams2.needsMeasure = false;
                        childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (((float) i14) * layoutParams2.widthFactor), 1073741824), View.MeasureSpec.makeMeasureSpec((i8 - paddingTop) - paddingBottom, 1073741824));
                    }
    ...
    private boolean performDrag(float f) {
        ...
        if (scrollX < f3) {
            ...
            if (z3) {
                this.mRightEdge.onPull(Math.abs(scrollX - f4) / ((float) clientWidth));
                z = true;
            }
            scrollX = f4;
        }
    ...
    private int determineTargetPage(int i, float f, int i2, int i3) {
        ...
        if (Math.abs(i3) <= this.mFlingDistance || Math.abs(i2) <= this.mMinimumVelocity) {
            i4 = i + ((int) (f + (i >= this.mCurItem ? 0.4f : 0.6f)));
        } else {
            i4 = i2 > 0 ? i : i + 1;
        }
        if (this.mItems.size() <= 0) {
        ...
        return Math.max(this.mItems.get(0).position, Math.min(i4, this.mItems.get(this.mItems.size() - 1).position));
    }
