    ...
    public void onMeasure(int i, int i2) {
        ...
        if (View.MeasureSpec.getMode(i) != 1073741824) {
            ...
            if (this.mCustomView != null) {
                ...
                this.mCustomView.measure(View.MeasureSpec.makeMeasureSpec(layoutParams.width >= 0 ? Math.min(layoutParams.width, paddingLeft) : paddingLeft, i5), View.MeasureSpec.makeMeasureSpec(layoutParams.height >= 0 ? Math.min(layoutParams.height, i4) : i4, layoutParams.height != -2 ? 1073741824 : Integer.MIN_VALUE));
            }
            if (this.mContentHeight <= 0) {
                int i6 = 0;
