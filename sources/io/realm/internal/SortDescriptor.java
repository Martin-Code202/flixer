...
public class SortDescriptor {
    ...
    private static SortDescriptor getInstance(FieldDescriptor.SchemaProxy schemaProxy, Table table2, String[] strArr, Sort[] sortArr, Set<RealmFieldType> set, Set<RealmFieldType> set2, String str) {
