...
import o.EA;
import o.FO;
final class ConfirmFragment$initClickListeners$3$1$1 extends FunctionReference implements AbstractC1451Fl<MoneyballData, Status, EA> {
    ConfirmFragment$initClickListeners$3$1$1(ConfirmFragment confirmFragment) {
    ...
    public final FO getOwner() {
        return C1461Fv.m5035(ConfirmFragment.class);
    }
