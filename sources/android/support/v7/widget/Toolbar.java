...
public class Toolbar extends ViewGroup {
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).mViewType == 0 && shouldLayout(childAt)) {
                ...
                i3 = Math.max(i3, childAt.getMeasuredHeight() + getVerticalMargins(childAt));
        ...
        if (shouldLayout(this.mTitleTextView)) {
            measureChildCollapseMargins(this.mTitleTextView, i, max2 + i11, i2, i10, iArr);
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            i8 = Math.max(i8, measureChildCollapseMargins(this.mSubtitleTextView, i, max2 + i11, i2, i9 + i10, iArr));
        ...
        setMeasuredDimension(View.resolveSizeAndState(Math.max(max2 + i8 + getPaddingLeft() + getPaddingRight(), getSuggestedMinimumWidth()), i, -16777216 & i4), shouldCollapse() ? 0 : View.resolveSizeAndState(Math.max(max3 + getPaddingTop() + getPaddingBottom(), getSuggestedMinimumHeight()), i2, i4 << 16));
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (shouldLayout(this.mNavButtonView)) {
            if (z2) {
                i7 = layoutChildRight(this.mNavButtonView, i7, iArr, min);
            } else {
                i6 = layoutChildLeft(this.mNavButtonView, i6, iArr, min);
            }
        }
        if (shouldLayout(this.mCollapseButtonView)) {
            if (z2) {
        ...
        int min2 = Math.min(i7, (width - paddingRight) - currentContentInsetRight);
        if (shouldLayout(this.mExpandedActionView)) {
            if (z2) {
        ...
        for (int i21 = 0; i21 < size; i21++) {
            max = layoutChildLeft(this.mTempViews.get(i21), max, iArr, min);
        }
        addCustomViewsWithGravity(this.mTempViews, 5);
        int size2 = this.mTempViews.size();
        for (int i22 = 0; i22 < size2; i22++) {
            min2 = layoutChildRight(this.mTempViews.get(i22), min2, iArr, min);
        }
        ...
        for (int i25 = 0; i25 < size3; i25++) {
            i23 = layoutChildLeft(this.mTempViews.get(i25), i23, iArr, min);
        }
