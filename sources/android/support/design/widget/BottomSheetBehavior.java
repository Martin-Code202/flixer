...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public boolean shouldHide(View view, float f) {
        ...
        return view.getTop() >= this.mMaxOffset && Math.abs((((float) view.getTop()) + (0.1f * f)) - ((float) this.mMaxOffset)) / ((float) this.mPeekHeight) > 0.5f;
    }
    ...
    public void dispatchOnSlide(int i) {
        ...
        if (v != null && this.mCallback != null) {
            if (i > this.mMaxOffset) {
                this.mCallback.onSlide(v, ((float) (this.mMaxOffset - i)) / ((float) (this.mParentHeight - this.mMaxOffset)));
            } else {
                this.mCallback.onSlide(v, ((float) (this.mMaxOffset - i)) / ((float) (this.mMaxOffset - this.mMinOffset)));
            }
        }
    }
