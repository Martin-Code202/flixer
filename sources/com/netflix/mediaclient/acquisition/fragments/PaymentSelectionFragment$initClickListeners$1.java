...
public final class PaymentSelectionFragment$initClickListeners$1 implements View.OnClickListener {
    final /* synthetic */ PaymentSelectionFragment this$0;

    PaymentSelectionFragment$initClickListeners$1(PaymentSelectionFragment paymentSelectionFragment) {
    ...
    public final void onClick(View view) {
        ...
        if (paymentSelectionClickListener != null) {
            paymentSelectionClickListener.onPaymentGiftCardClick();
        }
    }
}
