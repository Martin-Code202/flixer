...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private int evaluateColorChange(float f, int i, int i2) {
        ...
        int i5 = (i >> 8) & 255;
        int i6 = i & 255;
        return ((((int) (((float) (((i2 >> 24) & 255) - i3)) * f)) + i3) << 24) | ((((int) (((float) (((i2 >> 16) & 255) - i4)) * f)) + i4) << 16) | ((((int) (((float) (((i2 >> 8) & 255) - i5)) * f)) + i5) << 8) | (((int) (((float) ((i2 & 255) - i6)) * f)) + i6);
    }
    ...
    private void applyTransformation(float f, Ring ring, boolean z) {
        ...
        if (this.mFinishing) {
            ...
            if (f < 0.5f) {
                ...
                f2 = f3 + (MATERIAL_INTERPOLATOR.getInterpolation(f / 0.5f) * 0.79f) + 0.01f;
            } else {
            ...
            setRotation(216.0f * (this.mRotationCount + f));
        }
    }
