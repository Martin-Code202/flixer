...
final class WelcomeFragment$initLongClickListeners$1 implements View.OnLongClickListener {
    ...
    public final boolean onLongClick(View view) {
        ...
        debugBillingManager.restoreSubscription(new AbstractC1451Fl<Integer, List<? extends C0738>, EA>(this.this$0) { // from class: com.netflix.mediaclient.acquisition.fragments.WelcomeFragment$initLongClickListeners$1.1
