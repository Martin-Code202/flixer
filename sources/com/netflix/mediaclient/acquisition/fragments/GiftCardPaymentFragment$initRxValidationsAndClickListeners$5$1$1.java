...
import o.EA;
import o.FO;
final class GiftCardPaymentFragment$initRxValidationsAndClickListeners$5$1$1 extends FunctionReference implements AbstractC1451Fl<MoneyballData, Status, EA> {
    GiftCardPaymentFragment$initRxValidationsAndClickListeners$5$1$1(GiftCardPaymentFragment giftCardPaymentFragment) {
    ...
    public final FO getOwner() {
        return C1461Fv.m5035(GiftCardPaymentFragment.class);
    }
