...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent, NestedScrollingChild2 {
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        View findFocus = findFocus();
        if (null != findFocus && this != findFocus && isWithinDeltaOfScreen(findFocus, 0, i4)) {
