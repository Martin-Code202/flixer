...
public abstract class FieldDescriptor {
    ...
    public static FieldDescriptor createFieldDescriptor(SchemaProxy schemaProxy, Table table, String str, Set<RealmFieldType> set, Set<RealmFieldType> set2) {
        ...
        if (schemaProxy == null || !schemaProxy.hasCache()) {
            fieldDescriptor = new DynamicFieldDescriptor(table, str, null != set ? set : SIMPLE_LINK_FIELD_TYPES, set2);
        } else {
            fieldDescriptor = new CachedFieldDescriptor(schemaProxy, table.getClassName(), str, null != set ? set : ALL_LINK_FIELD_TYPES, set2);
        }
