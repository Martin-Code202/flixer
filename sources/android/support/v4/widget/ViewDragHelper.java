...
public class ViewDragHelper {
    ...
    private int computeAxisDuration(int i, int i2, int i3) {
        ...
        if (abs > 0) {
            ...
            i4 = (int) ((1.0f + (((float) Math.abs(i)) / ((float) i3))) * 256.0f);
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:45:0x0156, code lost:
        if (r16 != r14) goto L_0x0163;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean shouldInterceptTouchEvent(android.view.MotionEvent r23) {
        /*
        ...
        switch (actionMasked) {
            ...
            case 2:
                if (this.mDragState != 1) {
                    ...
                    int i3 = (int) (x3 - this.mLastMotionX[this.mActivePointerId]);
            ...
            case 5:
                ...
                if (this.mDragState == 0) {
                    ...
                    if ((this.mTrackingEdges & i5) != 0) {
                        this.mCallback.onEdgeTouched(this.mTrackingEdges & i5, pointerId3);
                        return;
                    }
                    return;
