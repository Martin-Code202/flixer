...
import o.EA;
import o.FO;
final class PlanSelectionFragment$initClickListeners$1$1$1 extends FunctionReference implements AbstractC1451Fl<MoneyballData, Status, EA> {
    PlanSelectionFragment$initClickListeners$1$1$1(PlanSelectionFragment planSelectionFragment) {
    ...
    public final FO getOwner() {
        return C1461Fv.m5035(PlanSelectionFragment.class);
    }
