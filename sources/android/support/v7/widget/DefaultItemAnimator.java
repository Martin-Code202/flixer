    ...
    public void runPendingAnimations() {
        ...
        if (z || z2 || z4 || z3) {
            ...
            if (z2) {
                ...
                AnonymousClass1 r8 = new Runnable() { // from class: android.support.v7.widget.DefaultItemAnimator.1
                ...
                if (z) {
                    ViewCompat.postOnAnimationDelayed(arrayList.get(0).holder.itemView, r8, getRemoveDuration());
                } else {
                    r8.run();
                }
            }
            if (z3) {
                ...
                AnonymousClass2 r82 = new Runnable() { // from class: android.support.v7.widget.DefaultItemAnimator.2
                    @Override // java.lang.Runnable
                    public void run() {
                ...
                if (z) {
                    ViewCompat.postOnAnimationDelayed(arrayList2.get(0).oldHolder.itemView, r82, getRemoveDuration());
                } else {
                    r82.run();
                }
            }
            if (z4) {
                ...
                AnonymousClass3 r83 = new Runnable() { // from class: android.support.v7.widget.DefaultItemAnimator.3
                    @Override // java.lang.Runnable
                    public void run() {
                ...
                if (z || z2 || z3) {
                    ViewCompat.postOnAnimationDelayed(arrayList3.get(0).itemView, r83, (z ? getRemoveDuration() : 0) + Math.max(z2 ? getMoveDuration() : 0, z3 ? getChangeDuration() : 0));
                } else {
                    r83.run();
                }
            }
