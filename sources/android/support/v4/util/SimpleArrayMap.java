...
public class SimpleArrayMap<K, V> {
    ...
    public int indexOfNull() {
        ...
        if (binarySearchHashes < 0 || null == this.mArray[binarySearchHashes << 1]) {
            return binarySearchHashes;
        }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r7v0, resolved type: android.support.v4.util.SimpleArrayMap<K, V> */
