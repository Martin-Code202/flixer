...
public class AppCompatProgressBarHelper {
    ...
    private Drawable tileifyIndeterminate(Drawable drawable) {
        ...
        for (int i = 0; i < numberOfFrames; i++) {
            ...
            tileify.setLevel(SubtitleDownloadRetryPolicy.DEFAULT_INITIAL_INTERVAL_MS);
            animationDrawable2.addFrame(tileify, animationDrawable.getDuration(i));
        }
        animationDrawable2.setLevel(SubtitleDownloadRetryPolicy.DEFAULT_INITIAL_INTERVAL_MS);
