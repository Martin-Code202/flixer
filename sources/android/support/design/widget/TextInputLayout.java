    ...
    private void setError(final CharSequence charSequence, boolean z) {
        ...
        if (this.mErrorShown) {
            ...
            if (z) {
                ...
                this.mErrorView.animate().alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new AnimatorListenerAdapter() { // from class: android.support.design.widget.TextInputLayout.2
            ...
            if (z) {
                this.mErrorView.animate().alpha(0.0f).setDuration(200).setInterpolator(AnimationUtils.FAST_OUT_LINEAR_IN_INTERPOLATOR).setListener(new AnimatorListenerAdapter() { // from class: android.support.design.widget.TextInputLayout.3
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    ...
    public void drawableStateChanged() {
        if (!this.mInDrawableStateChanged) {
            ...
            if (this.mCollapsingTextHelper != null) {
                z = this.mCollapsingTextHelper.setState(drawableState) | false;
            }
            if (z) {
                invalidate();
            }
