...
public class ListPopupWindow implements ShowableListMenu {
    ...
    public void show() {
        ...
        if (!this.mPopup.isShowing()) {
            ...
            this.mPopup.setOutsideTouchable(!this.mForceIgnoreOutsideTouch && !this.mDropDownAlwaysVisible);
            this.mPopup.update(getAnchorView(), this.mDropDownHorizontalOffset, this.mDropDownVerticalOffset, i3 < 0 ? -1 : i3, i4 < 0 ? -1 : i4);
        }
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r10v3, resolved type: android.widget.LinearLayout */
    ...
    private int buildDropDown() {
        ...
        switch (this.mDropDownWidth) {
            case PagerAdapter.POSITION_NONE /* -2 */:
                i2 = View.MeasureSpec.makeMeasureSpec(this.mContext.getResources().getDisplayMetrics().widthPixels - (this.mTempRect.left + this.mTempRect.right), Integer.MIN_VALUE);
                break;
            case -1:
                i2 = View.MeasureSpec.makeMeasureSpec(this.mContext.getResources().getDisplayMetrics().widthPixels - (this.mTempRect.left + this.mTempRect.right), 1073741824);
                break;
            default:
                i2 = View.MeasureSpec.makeMeasureSpec(this.mDropDownWidth, 1073741824);
                break;
        }
        int measureHeightOfChildrenCompat = this.mDropDownList.measureHeightOfChildrenCompat(i2, 0, -1, maxAvailableHeight - i5, -1);
        if (measureHeightOfChildrenCompat > 0) {
            i5 += i + this.mDropDownList.getPaddingTop() + this.mDropDownList.getPaddingBottom();
        }
