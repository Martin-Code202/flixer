...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    private Animation startAlphaAnimation(final int i, final int i2) {
        AnonymousClass4 r2 = new Animation() { // from class: android.support.v4.widget.SwipeRefreshLayout.4
            @Override // android.view.animation.Animation
            public void applyTransformation(float f, Transformation transformation) {
    ...
    private void moveSpinner(float f) {
        ...
        this.mProgress.setProgressRotation((((0.4f * max) - 16.0f) + (2.0f * pow)) * 0.5f);
        setTargetOffsetTopAndBottom(i - this.mCurrentTargetOffsetTop);
    }
    ...
    private void finishSpinner(float f) {
        ...
        AnonymousClass5 r3 = null;
        if (!this.mScale) {
            r3 = new Animation.AnimationListener() { // from class: android.support.v4.widget.SwipeRefreshLayout.5
                @Override // android.view.animation.Animation.AnimationListener
                public void onAnimationStart(Animation animation) {
                }
