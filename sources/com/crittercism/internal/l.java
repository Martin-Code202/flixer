...
public final class l extends k {
    ...
    /* JADX WARN: Type inference failed for: r0v1, types: [java.net.Socket, com.crittercism.internal.p] */
    ...
    public final java.net.Socket createSocket(java.net.Socket r10, java.lang.String r11, int r12, boolean r13) {
        /*
            r9 = this;
            org.apache.harmony.xnet.provider.jsse.SSLParametersImpl r0 = r9.c
            org.apache.harmony.xnet.provider.jsse.SSLParametersImpl r8 = a(r0)
            com.crittercism.internal.p r0 = new com.crittercism.internal.p
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.crittercism.internal.l.createSocket(java.net.Socket, java.lang.String, int, boolean):java.net.Socket");
    }

    /* JADX WARN: Type inference failed for: r0v0, types: [java.net.Socket, com.crittercism.internal.n] */
    /* JADX WARNING: Unknown variable types count: 1 */
    ...
    public final java.net.Socket createSocket(java.lang.String r7, int r8) {
        /*
            ...
            org.apache.harmony.xnet.provider.jsse.SSLParametersImpl r3 = r6.c
            org.apache.harmony.xnet.provider.jsse.SSLParametersImpl r5 = a(r3)
            r3 = r7
            r4 = r8
            r0.<init>(r1, r2, r3, r4, r5)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.crittercism.internal.l.createSocket(java.lang.String, int):java.net.Socket");
    }
    ...
    public final java.net.Socket createSocket(java.lang.String r9, int r10, java.net.InetAddress r11, int r12) {
        /*
            ...
            org.apache.harmony.xnet.provider.jsse.SSLParametersImpl r3 = r8.c
            org.apache.harmony.xnet.provider.jsse.SSLParametersImpl r7 = a(r3)
            r3 = r9
            r4 = r10
            r5 = r11
            r6 = r12
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.crittercism.internal.l.createSocket(java.lang.String, int, java.net.InetAddress, int):java.net.Socket");
    }
    ...
    public final java.net.Socket createSocket(java.net.InetAddress r7, int r8) {
        /*
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.crittercism.internal.l.createSocket(java.net.InetAddress, int):java.net.Socket");
    }
    ...
    public final java.net.Socket createSocket(java.net.InetAddress r9, int r10, java.net.InetAddress r11, int r12) {
        /*
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.crittercism.internal.l.createSocket(java.net.InetAddress, int, java.net.InetAddress, int):java.net.Socket");
    }
