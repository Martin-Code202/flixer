...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        for (int i11 = 0; i11 < i4; i11++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i8) {
                ...
                if (this.mOrientation == 1) {
                    i2 = getChildMeasureSpec(spaceForSpanRange, 1073741824, i13, layoutParams.width, false);
                    i = View.MeasureSpec.makeMeasureSpec(i8 - i12, 1073741824);
                } else {
                    i2 = View.MeasureSpec.makeMeasureSpec(i8 - i13, 1073741824);
                    i = getChildMeasureSpec(spaceForSpanRange, 1073741824, i12, layoutParams.height, false);
                }
                measureChildWithDecorationsAndMargin(view3, i2, i, true);
            }
        }
    ...
    private void measureChild(View view, int i, boolean z) {
        ...
        if (this.mOrientation == 1) {
            ...
            i2 = getChildMeasureSpec(spaceForSpanRange, i, i4, layoutParams.height, false);
            i3 = getChildMeasureSpec(this.mOrientationHelper.getTotalSpace(), getWidthMode(), i5, layoutParams.width, true);
        }
    ...
    public View onFocusSearchFailed(View view, int i, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        int i9 = -1;
        int i10 = 0;
        int spanGroupIndex = getSpanGroupIndex(recycler, state, i4);
        for (int i11 = i4; i11 != i2; i11 += i3) {
