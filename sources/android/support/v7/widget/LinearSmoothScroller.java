...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    public void updateActionForInterimTarget(RecyclerView.SmoothScroller.Action action) {
        ...
        action.update((int) (((float) this.mInterimTargetDx) * 1.2f), (int) (((float) this.mInterimTargetDy) * 1.2f), (int) (((float) calculateTimeForScrolling(SubtitleDownloadRetryPolicy.DEFAULT_INITIAL_INTERVAL_MS)) * 1.2f), this.mLinearInterpolator);
    }
