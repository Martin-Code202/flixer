...
public class TooltipPopup {
    ...
    private void computePosition(View view, int i, int i2, boolean z, WindowManager.LayoutParams layoutParams) {
        ...
        layoutParams.x = (this.mTmpAnchorPos[0] + i3) - (appRootView.getWidth() / 2);
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(0, 0);
        this.mContentView.measure(makeMeasureSpec, makeMeasureSpec);
        int measuredHeight = this.mContentView.getMeasuredHeight();
        int i7 = ((this.mTmpAnchorPos[1] + i4) - dimensionPixelOffset3) - measuredHeight;
        int i8 = this.mTmpAnchorPos[1] + i5 + dimensionPixelOffset3;
        if (z) {
            if (i7 >= 0) {
                layoutParams.y = i7;
            } else {
        ...
        } else if (i8 + measuredHeight <= this.mTmpDisplayFrame.height()) {
            layoutParams.y = i8;
        } else {
            layoutParams.y = i7;
        }
