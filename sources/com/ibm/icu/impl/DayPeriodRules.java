...
public final class DayPeriodRules {
    ...
    public enum CutoffType {
        ...
        public static CutoffType fromStringOrNull(CharSequence charSequence) {
            if (NetflixActivity.EXTRA_FROM.contentEquals(charSequence)) {
                return FROM;
            }
    ...
    public static final class DayPeriodRulesDataSink extends UResource.Sink {
        ...
        private void addCutoff(CutoffType cutoffType2, String str) {
            ...
            iArr[parseHour] = iArr[parseHour] | (1 << cutoffType2.ordinal());
        }
    ...
    public static DayPeriodRules getInstance(ULocale uLocale) {
        ...
        Integer num = null;
        while (num == null) {
            num = DATA.localesToRuleSetNumMap.get(name);
            if (num != null) {
                break;
            }
    ...
    private static DayPeriodRulesData loadData() {
        ...
        ICUResourceBundle bundleInstance = ICUResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt59b", "dayPeriods", ICUResourceBundle.ICU_DATA_CLASS_LOADER, true);
    ...
    private int getStartHourForDayPeriod(DayPeriod dayPeriod) {
